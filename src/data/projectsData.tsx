...
export const ProjectData: ProjectDataType[] = [
  {
    ...
    title: 'Xpensity V2',
    text: [
      'Everyone needs a budgeting tool. Xpensity can help you to get in control of your own daily expenditures. This mobile-first Progressive Web App enables the user to record quick transactions on-the-go. With lightning-fast load time, custom category tags and easy access to the number pad, you can record a transaction in seconds.',
      'The second iteration of this app is built with React. Changes were made to the UI to motivate and guide user behaviours. The complete separation of income and expenditure tabs forces the user to make a category selection when creating a record. Additionally, data-visualization was added using Apache ECharts for better user experience. Custom labels were dropped after poor feedback from the first iteration.',
    ],
    secondary: [
      'PWA',
      'React',
  ...
  },
  {
    ...
    title: 'Portfolio',
    text: [
      'I woke up one morning at 4:44 a.m.',
      "I've been thinking about the portfolio for a while and doing some prep work. However, at the same time, there were some uncertainties. I didn't know what colours to use until the idea came to me at 4:44 a.m. that particular morning. I should just use the colours from Jay-Z's album 4:44.",
      "The album was released at a very special time in his career. Jay-Z had finally made it to the billionaire's club. He was no longer a rapper and a street hustler, but a businessman, a husband, and a father. Matured, experienced and wealthy, yet, he still struggles with many problems he’s had for years. Fame, success, setbacks, racism, betrayals, the possibility that he cheated on his wife — it's the most loaded and serious discussion that he has delivered.",
      "This portfolio is an attempt to recapture the feeling when I appreciated the album for the very first time. It's complicated but fulfilling. This is the best work I've produced so far, and I drew inspirations from many places I visited along the way. I credited them in the about page.",
    ],
    secondary: [
      'React',
      'TypeScript',
    ...
    mobileFirst: true,
    githubLink: 'https://github.com/francislagares/francis-portfolio',
    liveLink: 'https://francislagares.com/',
    next: 'xpensity-v1',
  },
  {
    id: 'xpensity-v1',
  ...
  },
  {
    ...
    title: 'Agency',
    text: [
      'I had to do it. I just had to build a digital agency website. Prior to transitioning into web development and graduate school, I was trained in communications and previously worked in advertising agencies of various scales. From the smaller, modest creative agencies to 4A agencies, they all share something in common, that is, a stunning website with smooth animations and creative interactions.',
      'This project was built concurrently as I explored the framer motions library. I came across this motion library and I was immediately hooked by its functionalities and capabilities. It was a great venture to hone my react skills and create cool transitions. Link to the live version is listed above.',
    ],
    secondary: [
      'React',
      'TypeScript',
  ...
  },
  {
    ...
    title: 'E-Commerce',
    text: [
      'I build this project while learning React and Redux for the very first time. I found a course on Udemy made by Andrei Neagoie and Yihua Zhang, and this project was part of the course as I learned the basics of React, React Router, Redux, and many other things. ',
      "I did not build the website exactly how it was built in the course, because I wanted to integrate more features and make things look like an actual E-Commerce website. Pictures used in this project are all from a small boutique in the New England region called Kiel Patrick James. They sell nice bracelets. If you have time, I'd recommend you to checkout their website and look around. ",
      "Keep in mind that this project was built a while ago and I write much better code now. But I still want to put this up here since it's a substantial project. ",
    ],
    secondary: [
      'React',
      'Redux',
